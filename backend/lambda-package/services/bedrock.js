...
exports.invokeClaudeModel = invokeClaudeModel;
exports.generateEligibilityExplanation = generateEligibilityExplanation;
exports.generateChatResponse = generateChatResponse;
exports.sanitizeUserInput = sanitizeUserInput;
exports.containsApprovalPromise = containsApprovalPromise;
exports.generateFollowUpSuggestions = generateFollowUpSuggestions;
 ...
 */
async function invokeClaudeModel(prompt, systemPrompt, maxTokens = MAX_TOKENS) {
 ...
 */
async function generateEligibilityExplanation(schemeName, schemeDescription, isEligible, userProfile, criteria, language = 'en') {
 ...
 */
async function generateChatResponse(userQuery, userProfile, conversationHistory, retrievedDocuments, language = 'en') {
    const languageName = language === 'hi' ? 'Hindi' : 'English';
 ...
 */
function determineConfidence(response, documentCount) {
    ...
    const hasLowConfidenceIndicator = lowConfidenceIndicators.some(indicator => response.toLowerCase().includes(indicator.toLowerCase()));
 ...
 */
function containsApprovalPromise(response) {
 ...
 */
function generateFollowUpSuggestions(userQuery, userProfile) {
    const suggestions = [];
